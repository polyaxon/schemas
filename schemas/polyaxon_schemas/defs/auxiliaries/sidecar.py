...
class V1PolyaxonSidecarContainer(BaseConfig, polyaxon_sdk.V1PolyaxonSidecarContainer):
    ...
    def get_image(self, default_version: str):
        image = self.image or "polyaxon/polyaxon-sidecar"
        image_tag = self.image_tag if self.image_tag is not None else default_version
...
def get_default_sidecar_container(default_version: str, schema=True):
    default = {
        "image": "polyaxon/polyaxon-sidecar",
